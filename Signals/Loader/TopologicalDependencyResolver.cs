...
/// <remarks>
/// <list type="bullet">
/// <item>Implements <see cref="IPluginDependencyResolver"/> to ensure that plugins are loaded respecting their dependencies.</item>
...
/// <item>Produces an array of <see cref="PluginManifest"/> sorted so that each plugin appears after its dependencies.</item>
/// <item>Supports case-insensitive plugin IDs.</item>
/// </list>
/// </remarks>

public sealed class TopologicalDependencyResolver : IPluginDependencyResolver
{
    /// <inheritdoc />
    public PluginManifest[] SortByDependencies(IEnumerable<PluginManifest> manifests)
    {
